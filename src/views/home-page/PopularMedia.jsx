...
const PopularMedia = ({ poster, ranking }) => {
  ...
  return (
    <div
      className="ranking__number__parent"
      style={{ display: "flex", alignItems: "center" }}
    >
      <h1 className="ranking__number">{ranking}</h1>
      <div
        ...
        <div style={{ marginLeft: "2.5em" }}>
          ...
          >
            <img
              src={poster}
              className={
                isHover ? "media__landscape__container__img" : "opacity"
              }
              alt=""
            />
          </div>
